...
public void showWin(String msg) {
        ...
        JLabel result = new JLabel(msg, SwingConstants.CENTER);
        result.setFont(new Font("Jokerman", Font.BOLD, 26));
        result.setForeground(new Color(199,21,133));
        winWindow.add(result, BorderLayout.CENTER);
        ...
        winWindow.getContentPane().setBackground(new Color(255, 228, 225));  // Soft pink
        bottom.setBackground(new Color(255, 228, 225));  // Match panel too
